// $Id: SampleTests2.java 156 2013-02-22 20:34:14Z cs671a $
...
@charpov.grader.Test(val=29)
class SampleTests2 {

  public static void main (String[] args) throws Exception {
    java.util.logging.Logger.getLogger("charpov.grader")
      .setLevel(java.util.logging.Level.WARNING);
    charpov.grader.Tester tester = new charpov.grader.Tester(SampleTests2.class);
    tester.run();
  }
  TestResult[] results;
  String[] output;
